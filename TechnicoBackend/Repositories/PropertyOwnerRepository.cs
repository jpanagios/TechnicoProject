...
namespace TechnicoBackend.Repositories
{
    public class PropertyOwnerRepository : IPropertyOwnerRepository
    {
        ...
        private readonly ILogger<PropertyOwnerRepository> _logger;

        public PropertyOwnerRepository(TechnicoDbContext context, ILogger<PropertyOwnerRepository> logger)
        {
            _context = context;
            _logger = logger;
        }
        ...
        {
            _logger.LogInformation("Fetching all property owners from the database.");
